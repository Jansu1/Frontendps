            ...
            <div>
                <div className="row">
                    ...
                    <div className="col">
                        <form>
                            <div className="form-group">
                                <label for="formFileDisabled" className="form-label">Upload Image</label>
                            ...
                            <div className="form-group">
                                ...
                                <input type="company" className="form-control" id="exampleInputCompany" placeholder="Company" />
                            </div><br />
                            <div className="form-group">
                                <label for="exampleInputDescription">Description</label>
                                <input type="password" className="form-control" id="exampleInputDescription" placeholder="Description" />
                            </div><br />
                            <div className="col">
                                <h3>College</h3>
                    ...
                    <div className="col">
                        <form>
                            <div className="form-group">
                                <label for="formFileDisabled" className="form-label">Upload Resume</label>
                                <input className="form-control" type="file" id="formFileDisabled" disabled />
                            </div><br />
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <input type="company" className="form-control" id="exampleInputCompany" placeholder="Unique Id" />
                            </div><br />
                            <div className="form-group">
                                <label for="exampleInputDescription">Description</label>
                                <input type="password" className="form-control" id="exampleInputDescription" placeholder="Description" />
                            ...
                            <form action="/action_page.php">
                                <label for="birthday"><b>Date of Birth</b></label><br /><br />
                            ...
                            <div className="text-center">
                                <a href="/Newdash" className="btn btn-success " style={{width:"10%"}}>
                                    Submit</a>
                            </div>
